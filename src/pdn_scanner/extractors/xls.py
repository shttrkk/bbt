...
def _normalize_header_name(header: str, index: int) -> str:
    ...
    aliases: tuple[tuple[str, tuple[str, ...]], ...] = (
        ("ФИО", ("фамилия", "фио", "инициалы", "full name", "name")),
        ("email", ("e-mail", "email", "электронн", "почт")),
        ("телефон", ("телефон", "phone", "моб")),
        ("адрес", ("адрес", "address")),
        ("дата рождения", ("дата рождения", "birth date", "date_of_birth", "dob")),
        ("место рождения", ("место рождения", "birth place", "place_of_birth")),
