...
def write_summary_csv(output_dir: Path, summary: RunSummary, results: list[FileScanResult], config: AppConfig) -> Path:
    ...
    fieldnames = [
        ...
        "validated_entities_count",
        "suspicious_entities_count",
        "confidence_summary",
        "is_template",
        "is_public_doc",
        "is_reference_data",
            ...
            writer.writerow(
                {
                    ...
                    "storage_class": result.storage_class.value,
                    ...
                    "validated_entities_count": result.validated_entities_count,
                    "suspicious_entities_count": result.suspicious_entities_count,
                    "confidence_summary": _format_mapping(result.confidence_summary),
                    "is_template": result.is_template,
                    "is_public_doc": result.is_public_doc,
                    "is_reference_data": result.is_reference_data,
